...
def join_ride(rideId):
		...
		if res1.status_code==404:
			...
			res1=requests.post('http://34.238.29.50:8080/api/v1/db/read',json=task1)
...
def new_ride():
		...
		#print("Re1")
                res1=requests.get("http://34.238.29.50:8080/api/v1/users")
		print(res1.json())
...
def clear_db():
	...
	#	return json.dumps({}),400
        ...
        res1=requests.post('http://34.238.29.50:8000/api/v1/db/write',json=task2)
        if res1.status_code==200:
                    task3={"method":"clearcride","table":"cride","insert":("rideid"),"column":["rideId"]}
                    res1=requests.post('http://34.238.29.50:8000/api/v1/db/write',json=task3)
                    if res1.status_code==200:
